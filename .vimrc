...
"
" @recamilio .vimrc config, forked from Steve Francia (http://spf13.com)
"
" }
...
" Formatting {
    ...
    autocmd FileType haskell,scala,clojure setlocal expandtab shiftwidth=2 softtabstop=2 tabstop=2
...
" Plugins {
    ...
    " SnipMate {
        ...
        let g:snips_author = 'Renato M Camilio <renatomcamilio@gmail.com>'
    " }
